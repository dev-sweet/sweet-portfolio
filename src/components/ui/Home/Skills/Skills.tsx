...
const Skills = () => {
  return (
    ...
    //   {/* <LightRays /> */}
    //   <div
    //     className="min-h-screen w-full mx-auto py-20 text-white bg-gradient-to-b from-black/0 via-black/30 to-transparent
    //         backdrop-blur-[2px]"
    //   >
    ...
    <div>
      <div
        className="lg:min-h-screen w-full mx-auto py-20 text-white bg-gradient-to-b from-black/0 via-black/30 to-transparent 
            backdrop-blur-[2px]"
      >
        <div className="w-[90%] mx-auto">
          <h1 className="text-4xl font-bold text-gray-200 text-center">
