      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="bg-zinc-950/45 border border-zinc-850 rounded-[24px] p-6 backdrop-blur-md flex flex-col justify-between gap-6"
          >
            {/* JSON Code Window */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Milestone 1 */}
              <div className="flex items-start gap-4 p-4 rounded-xl bg-zinc-900/15 border border-zinc-900 hover:border-purple-500/20 transition-all duration-300">
                <div className="p-2.5 bg-zinc-950/80 rounded-lg border border-zinc-800 text-cyan-400 flex-shrink-0">
              ...
              {/* Milestone 2 */}
              <div className="flex items-start gap-4 p-4 rounded-xl bg-zinc-900/15 border border-zinc-900 hover:border-purple-500/20 transition-all duration-300">
                <div className="p-2.5 bg-zinc-950/80 rounded-lg border border-zinc-800 text-purple-400 flex-shrink-0">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6 }}
            className="bg-zinc-950/45 border border-zinc-850 rounded-[24px] p-6 backdrop-blur-md flex flex-col justify-between items-center text-center gap-6 min-h-[320px]"
          >
            {/* Title */}
            <h3 className="text-base sm:text-lg font-bold text-white tracking-tight mt-2">
              Tech Stack
            </h3>
            ...
            <div className="flex flex-col gap-4 items-center justify-center my-auto">
              ...
              <div className="flex gap-4">
                <div className="w-14 h-14 rounded-full border border-zinc-850 bg-zinc-900/30 flex items-center justify-center shadow-lg hover:border-cyan-400 hover:text-cyan-400 transition-colors duration-300">
            ...
            {/* System Status text */}
            <span className="text-[10px] font-mono text-emerald-400 uppercase tracking-widest font-bold mb-2">
              SYSTEMS READY
            </span>
          </motion.div>
